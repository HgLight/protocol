...
const (
	...
	User_UserDelete_FullMethodName                    = "/openim.user.user/userDelete"
...
func (c *userClient) UserDelete(ctx context.Context, in *UserDeleteReq, opts ...grpc.CallOption) (*UserDeleteResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServer) UserDelete(context.Context, *UserDeleteReq) (*UserDeleteResp, error) {
