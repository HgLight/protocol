...
func (x *UserDeleteReq) GetUserIDs() []string {
	if x != nil {
		return x.UserIDs
	}
	return nil
...
const file_user_user_proto_rawDesc = "" +
	...
	"\x10userRegisterResp\")\n" +
	"\ruserDeleteReq\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\x10\n" +
	"\x0euserDeleteResp\"4\n" +
	...
	"\x05value\x18\x03 \x01(\tR\x05value2\xd8\x17\n" +
	"\x04user\x12Z\n" +
	...
	"\fuserRegister\x12\x1c.openim.user.userRegisterReq\x1a\x1d.openim.user.userRegisterResp\x12E\n" +
	"\n" +
	"userDelete\x12\x1a.openim.user.userDeleteReq\x1a\x1b.openim.user.userDeleteResp\x12K\n" +
...
var file_user_user_proto_goTypes = []any{
	...
	(*UserDeleteReq)(nil),                     // 28: openim.user.userDeleteReq
	(*UserDeleteResp)(nil),                    // 29: openim.user.userDeleteResp
	...
	(*GetUserClientConfigReq)(nil),            // 71: openim.user.getUserClientConfigReq
	(*GetUserClientConfigResp)(nil),           // 72: openim.user.getUserClientConfigResp
	(*SetUserClientConfigReq)(nil),            // 73: openim.user.setUserClientConfigReq
	(*SetUserClientConfigResp)(nil),           // 74: openim.user.setUserClientConfigResp
	(*DelUserClientConfigReq)(nil),            // 75: openim.user.delUserClientConfigReq
	(*DelUserClientConfigResp)(nil),           // 76: openim.user.delUserClientConfigResp
	(*PageUserClientConfigReq)(nil),           // 77: openim.user.pageUserClientConfigReq
	(*PageUserClientConfigResp)(nil),          // 78: openim.user.pageUserClientConfigResp
	(*ClientConfig)(nil),                      // 79: openim.user.clientConfig
...
var file_user_user_proto_depIdxs = []int32{
	...
	63, // 26: openim.user.getNotificationAccountResp.account:type_name -> openim.user.notificationAccountInfo
	...
	38, // 29: openim.user.getAllOnlineUsersResp.StatusList:type_name -> openim.user.onlineStatus
	...
	79, // 33: openim.user.pageUserClientConfigResp.configs:type_name -> openim.user.clientConfig
	...
	30, // 38: openim.user.user.getGlobalRecvMessageOpt:input_type -> openim.user.getGlobalRecvMessageOptReq
	...
	28, // 42: openim.user.user.userDelete:input_type -> openim.user.userDeleteReq
	0,  // 43: openim.user.user.getAllUserID:input_type -> openim.user.getAllUserIDReq
	32, // 44: openim.user.user.userRegisterCount:input_type -> openim.user.userRegisterCountReq
	34, // 45: openim.user.user.subscribeOrCancelUsersStatus:input_type -> openim.user.subscribeOrCancelUsersStatusReq
	36, // 46: openim.user.user.getSubscribeUsersStatus:input_type -> openim.user.getSubscribeUsersStatusReq
	39, // 47: openim.user.user.getUserStatus:input_type -> openim.user.getUserStatusReq
	41, // 48: openim.user.user.setUserStatus:input_type -> openim.user.setUserStatusReq
	46, // 49: openim.user.user.processUserCommandAdd:input_type -> openim.user.processUserCommandAddReq
	50, // 50: openim.user.user.processUserCommandUpdate:input_type -> openim.user.processUserCommandUpdateReq
	48, // 51: openim.user.user.processUserCommandDelete:input_type -> openim.user.processUserCommandDeleteReq
	52, // 52: openim.user.user.processUserCommandGet:input_type -> openim.user.processUserCommandGetReq
	55, // 53: openim.user.user.processUserCommandGetAll:input_type -> openim.user.processUserCommandGetAllReq
	58, // 54: openim.user.user.addNotificationAccount:input_type -> openim.user.addNotificationAccountReq
	60, // 55: openim.user.user.updateNotificationAccountInfo:input_type -> openim.user.updateNotificationAccountInfoReq
	62, // 56: openim.user.user.searchNotificationAccount:input_type -> openim.user.searchNotificationAccountReq
	65, // 57: openim.user.user.getNotificationAccount:input_type -> openim.user.getNotificationAccountReq
	67, // 58: openim.user.user.sortQuery:input_type -> openim.user.sortQueryReq
	44, // 59: openim.user.user.setUserOnlineStatus:input_type -> openim.user.setUserOnlineStatusReq
	69, // 60: openim.user.user.getAllOnlineUsers:input_type -> openim.user.getAllOnlineUsersReq
	71, // 61: openim.user.user.getUserClientConfig:input_type -> openim.user.getUserClientConfigReq
	73, // 62: openim.user.user.setUserClientConfig:input_type -> openim.user.setUserClientConfigReq
	75, // 63: openim.user.user.delUserClientConfig:input_type -> openim.user.delUserClientConfigReq
	77, // 64: openim.user.user.pageUserClientConfig:input_type -> openim.user.pageUserClientConfigReq
	...
	31, // 69: openim.user.user.getGlobalRecvMessageOpt:output_type -> openim.user.getGlobalRecvMessageOptResp
	...
	29, // 73: openim.user.user.userDelete:output_type -> openim.user.userDeleteResp
	1,  // 74: openim.user.user.getAllUserID:output_type -> openim.user.getAllUserIDResp
	33, // 75: openim.user.user.userRegisterCount:output_type -> openim.user.userRegisterCountResp
	35, // 76: openim.user.user.subscribeOrCancelUsersStatus:output_type -> openim.user.subscribeOrCancelUsersStatusResp
	37, // 77: openim.user.user.getSubscribeUsersStatus:output_type -> openim.user.getSubscribeUsersStatusResp
	40, // 78: openim.user.user.getUserStatus:output_type -> openim.user.getUserStatusResp
	42, // 79: openim.user.user.setUserStatus:output_type -> openim.user.setUserStatusResp
	47, // 80: openim.user.user.processUserCommandAdd:output_type -> openim.user.processUserCommandAddResp
	51, // 81: openim.user.user.processUserCommandUpdate:output_type -> openim.user.processUserCommandUpdateResp
	49, // 82: openim.user.user.processUserCommandDelete:output_type -> openim.user.processUserCommandDeleteResp
	54, // 83: openim.user.user.processUserCommandGet:output_type -> openim.user.processUserCommandGetResp
	57, // 84: openim.user.user.processUserCommandGetAll:output_type -> openim.user.processUserCommandGetAllResp
	59, // 85: openim.user.user.addNotificationAccount:output_type -> openim.user.addNotificationAccountResp
	61, // 86: openim.user.user.updateNotificationAccountInfo:output_type -> openim.user.updateNotificationAccountInfoResp
	64, // 87: openim.user.user.searchNotificationAccount:output_type -> openim.user.searchNotificationAccountResp
	66, // 88: openim.user.user.getNotificationAccount:output_type -> openim.user.getNotificationAccountResp
	68, // 89: openim.user.user.sortQuery:output_type -> openim.user.sortQueryResp
	45, // 90: openim.user.user.setUserOnlineStatus:output_type -> openim.user.setUserOnlineStatusResp
	70, // 91: openim.user.user.getAllOnlineUsers:output_type -> openim.user.getAllOnlineUsersResp
	72, // 92: openim.user.user.getUserClientConfig:output_type -> openim.user.getUserClientConfigResp
	74, // 93: openim.user.user.setUserClientConfig:output_type -> openim.user.setUserClientConfigResp
	76, // 94: openim.user.user.delUserClientConfig:output_type -> openim.user.delUserClientConfigResp
	78, // 95: openim.user.user.pageUserClientConfig:output_type -> openim.user.pageUserClientConfigResp
